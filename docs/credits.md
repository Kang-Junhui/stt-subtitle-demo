...
- **STT 연동 로직** (`src/lib/server/rtzr.ts`): [RTZR 공식 API 문서](https://developers.rtzr.ai)에 포함된 `RTZROpenAPIClient` Python 예시 코드의 인증 토큰 캐싱 및 폴링(polling) 구조를 참고하여 TypeScript로 작성했습니다.
